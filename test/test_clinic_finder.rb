...
class TestClinicFinder < TestClass
  ...
  def test_that_distances_calculated_between_clinics_and_patient
    ...
    assert_equal [{:name=>"castro_family_planning", :distance=>0.92356303468274}, {:name=>"albuquerque_medical_center", :distance=>896.1457743896646}, {:name=>"butte_health_clinic", :distance=>166.91604621072125}, {:name=>"planned_parenthood_san_fran", :distance=>1.8319683663768311}, {:name=>"planned_parenthood_fresno", :distance=>162.90265337891927}, {:name=>"la_medical_center", :distance=>343.64715401101705}, {:name=>"planned_parenthood_la", :distance=>349.85375580282454}, {:name=>"womens_health_of_venice_beach", :distance=>343.72277289957947}, {:name=>"planned_parenthood_oakland", :distance=>9.580895789655901}, {:name=>"discreet_treatment_centers_of_ca", :distance=>86.62102600904686}, {:name=>"silcon_valley_womens_clinic", :distance=>42.90149676066583}], @abortron.calculate_distance
  end
